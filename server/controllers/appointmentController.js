...
//     // Validate required fields - ADD NEW VALIDATIONS
//     if (!userId) {
...
//     // NEW VALIDATION: Consultation type and price
//     if (!consultationType) {
//       return res.status(400).json({
...
//       appointmentDate: new Date(appointmentDate), // ADD DATE CHECK
...
//     // ❌❌❌ REMOVED DUPLICATE APPOINTMENT CHECK COMPLETELY ❌❌❌
//     // Anyone can book same time slot on same date now

//     // Create new appointment WITH CONSULTATION TYPE AND PRICE
...
//         consultationType: consultationType // ADD THIS TO TIME SLOT TOO
//       },
//       timeSlotId: timeSlotId,
//       status: "pending"
//     });
...
//       consultationType: appointment.consultationType, // ADD THIS
//       price: appointment.price, // ADD THIS
//       userId: userId,
...
// // Get appointments by user ID - UPDATED TO INCLUDE NEW FIELDS
...
// // Get all appointments - UPDATED TO INCLUDE NEW FIELDS
...
// // Get appointments by doctor ID - UPDATED TO INCLUDE NEW FIELDS
...
// // Get appointment by ID - UPDATED TO INCLUDE NEW FIELDS
