...
//       rating,
//       review,
//       doctorProfessionalism: req.body.doctorProfessionalism || 5,
//       waitingTime: req.body.waitingTime || 5,
//       facilityCleanliness: req.body.facilityCleanliness || 5,
//       overallExperience: req.body.overallExperience || 5
//     });
...
//     console.log('🔍 Looking for feedback for:', { appointmentId, userId });
...
//     const total = await Feedback.countDocuments({ doctorId });
...
//     // Check authorization
//     if (feedback.patientId !== req.body.patientId) {
...
//     const allowedUpdates = ['rating', 'review', 'doctorProfessionalism', 'waitingTime', 'facilityCleanliness', 'overallExperience'];
