...
const BookAppointment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Email validation
    if (patientDetails.email && !validateEmail(patientDetails.email)) {
  ...
  payment: {  // ✅ Add this payment object
      ...
      <div className="bg-white rounded-2xl max-w-md w-full">
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-green-900">Appointment Booked Successfully!</h2>
            <button
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              A confirmation email has been sent to <span className="font-semibold text-blue-600">{patientDetails.email}</span>
            </p>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p><span className="font-medium">Appointment #:</span> {appointmentData?.appointmentNumber}</p>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-yellow-700 text-sm">
              Please check your email inbox (and spam folder) for the appointment confirmation. 
              The email contains important details about your appointment.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="w-full bg-gray-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-gray-700 transition duration-200"
            >
              Go to Dashboard
            </button>
          </div>
  ...
  return (
    <>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="border-t pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        />
                        {patientDetails.email && !validateEmail(patientDetails.email) && (
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting || !selectedSlot || !appointmentDate || !userId || (patientDetails.email && !validateEmail(patientDetails.email))}
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      <div className="flex items-center">
                        ...
                        <p className="text-green-800 text-sm">
                          A confirmation email will be sent to <span className="font-semibold">{patientDetails.email}</span> after booking.
                        </p>
                      </div>
                    </div>
                  ) : (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                      <div className="flex items-center">
                        ...
                        <p className="text-yellow-800 text-sm">
                          <span className="font-semibold">Note:</span> No email provided. You won't receive email confirmation. 
                          Please save your appointment number <span className="font-bold">#{selectedSlot?.appointmentNumber}</span> for reference.
                        </p>
                      </div>
                    </div>
                  )}
      ...
      {/* Success Modal (shows when email is sent) */}
