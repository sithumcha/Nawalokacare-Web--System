...
// // src/pages/DoctorDetailsShow.jsx
// import { useState, useEffect } from "react";
// import { useParams, useNavigate } from "react-router-dom";
// import axios from "axios";
// import { FaStar, FaStarHalfAlt, FaRegStar, FaComment, FaThumbsUp, FaChartBar, FaUserFriends } from "react-icons/fa";
...
//         `http://localhost:5000/api/feedbacks/doctor/${doctorId}`
//       );
...
//           <FaStar key={`full-${i}`} className={`${size} text-yellow-400 fill-current`} />
//         ))}
//         {hasHalfStar && <FaStarHalfAlt className={`${size} text-yellow-400`} />}
//         {[...Array(emptyStars)].map((_, i) => (
//           <FaRegStar key={`empty-${i}`} className={`${size} text-yellow-400`} />
//         ))}
//       </div>
//     );
//   };
...
//     if (feedbackStats.totalReviews === 0) return 0;
//     const count = feedbackStats.ratingDistribution[rating] || 0;
//     return (count / feedbackStats.totalReviews) * 100;
//   };
...
//             {/* Time Slots Section (Moved up) */}
//             <div id="timeSlotsSection" className="bg-white rounded-2xl shadow-xl p-8">
...
//                   <button
//                     onClick={handleBookAppointment}
//                     className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-300 flex items-center shadow-md"
//                   >
//                     <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
//                     </svg>
...
//                   <div className="flex items-center justify-between">
//                     <div>
//                       <p className="text-orange-800 font-semibold flex items-center text-lg">
//                         🏥 Physical Consultations
//                       </p>
...
//                   <div className="flex items-center justify-between">
//                     <div>
//                       <p className="text-cyan-800 font-semibold flex items-center text-lg">
//                         💻 Online Consultations
//                       </p>
...
//                         {Math.round((consultationTypeStats.online.booked / (consultationTypeStats.online.total || 1)) * 100)}%
//                       </p>
//                       <p className="text-sm text-cyan-600">booked</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                       <p className="text-green-800 font-semibold text-lg mb-2">Selected Time Slot:</p>
//                       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
//                         <div>
//                           <p className="text-green-700 font-medium">Day & Time</p>
//                           <p className="text-green-900">
//                             {selectedSlot.day} • {formatTime(selectedSlot.startTime)} - {formatTime(selectedSlot.endTime)}
//                           </p>
//                         </div>
//                         <div>
//                           <p className="text-green-700 font-medium">Consultation Type</p>
//                           <p className={`font-bold ${selectedSlot.consultationType === 'physical' ? 'text-orange-600' : 'text-cyan-600'}`}>
//                             {selectedSlot.consultationType === 'physical' ? '🏥 Physical' : '💻 Online'}
//                           </p>
//                         </div>
//                         <div>
//                           <p className="text-green-700 font-medium">Appointment #</p>
//                           <p className="text-green-900 font-bold text-xl">{selectedSlot.appointmentNumber}</p>
//                         </div>
//                         <div>
//                           <p className="text-green-700 font-medium">Consultation Fee</p>
//                           <p className="text-green-900 font-bold text-xl">{formatPrice(doctor.price)}</p>
//                         </div>
//                       </div>
//                     </div>
//                     <button
...
//                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
//                   </svg>
//                   <h4 className="text-xl font-medium text-gray-900 mb-2">No Available Time Slots</h4>
//                   <p className="text-gray-500">
//                     {selectedDay || selectedConsultationType 
//                       ? "No slots match your current filters. Try adjusting your criteria."
//                       : "This doctor hasn't added any available time slots yet."
...
//                           isSelected
//                             ? 'border-green-500 bg-green-50 ring-2 ring-green-200 cursor-pointer transform scale-105'
//                             : isAvailable
//                             ? 'border-gray-200 hover:border-blue-300 hover:bg-blue-25 cursor-pointer hover:shadow-lg'
//                             : 'border-red-200 bg-red-50 cursor-not-allowed opacity-70'
//                         }`}
//                       >
//                         <div className="flex justify-between items-start mb-4">
//                           <div className="flex flex-col space-y-2">
//                             <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium ${getDayColor(slot.day)}`}>
//                               {slot.day}
//                             </span>
//                             <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium ${getConsultationTypeColor(slot.consultationType)}`}>
//                               {getConsultationTypeIcon(slot.consultationType)} {slot.consultationType === 'physical' ? 'Physical' : 'Online'}
//                             </span>
//                           </div>
//                           <div className="flex items-center space-x-2">
...
//                             <span>{slotBookingPercentage}% filled</span>
//                           </div>
//                         </div>
...
//                                 ✓ Available: Appointment #{nextAppointmentNumber}
//                               </span>
...
//                               ✗ Fully booked: All {stats.total} appointments are taken
//                             </span>
//                           )}
//                         </div>
//                       </div>
...
//             {/* Patient Reviews Section (Moved down below time slots) */}
...
//               <h3 className="text-xl font-bold text-blue-900 mb-4">Book an Appointment</h3>
              
//               {/* Price Display */}
//               <div className="mb-6 p-4 bg-white rounded-xl border border-blue-200 shadow-sm">
//                 <div className="text-center">
//                   <p className="text-sm text-gray-600 mb-1">Consultation Fee</p>
//                   <p className="text-3xl font-bold text-green-700">{formatPrice(doctor.price)}</p>
//                   <p className="text-xs text-gray-500">Per session</p>
//                 </div>
//               </div>
...
//               <button
//                 onClick={() => document.getElementById('timeSlotsSection')?.scrollIntoView({ behavior: 'smooth' })}
//                 className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-md hover:shadow-lg"
//               >
...
//                 <button 
//                   onClick={() => window.location.href = `tel:${doctor.phoneNumber}`}
//                   className="w-full flex items-center justify-center space-x-2 bg-green-600 text-white py-3 px-4 rounded-lg hover:bg-green-700 transition duration-200 font-medium"
//                 >
//                   <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
//                   </svg>
...
//                 <button 
//                   onClick={() => window.location.href = `mailto:${doctor.email}`}
//                   className="w-full flex items-center justify-center space-x-2 bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition duration-200 font-medium"
//                 >
//                   <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
//                   </svg>
...
//                   <span className="font-bold text-gray-900">
//                     {calculateTotalAppointmentCapacity()}
//                   </span>
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <span className="text-gray-700">Available Now</span>
//                   <span className="font-bold text-green-700">
//                     {calculateTotalAvailableAppointments()}
//                   </span>
//                 </div>
//                 <div className="flex items-center justify-between">
